    ...
    <body>
        ...
        <script>
            ...
            function submitComment(postID) {
                ...
                $.post('comment.php', { postID: postID, comment: commentText }, function(response) {
            ...
            $(document).on('show.bs.modal', '.modal', function() {
                const postID = $(this).find('.comment-btn').data('post-id');
                $.get('comments.php', { postID: postID }, function(response) {
            ...
            $('#createPostModal').on('hidden.bs.modal', function () {
                ...
                $('#createPostForm')[0].reset();  // Resetea el formulario
                // Limpiar la vista previa de la imagen y video
                $('#imageField').hide();
                $('#videoField').hide();
                $('#gifField').hide();
            });
